...
Get-ComputerDetails -ComputerName 127.0.0.1,localhost,xavierdesktop -Verbose -HardwareInformation -ApplicationsInstalled -LastPatchInstalled -LastReboot -Path .\