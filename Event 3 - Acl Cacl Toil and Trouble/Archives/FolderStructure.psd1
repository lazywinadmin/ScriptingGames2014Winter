...
ModuleToProcess = 'C:\MyModule.psm1'

# Version number of this module.
ModuleVersion = '1.0.0.0'

# ID used to uniquely identify this module
GUID = 'Copy "{$[System.Guid]::NewGuid().ToString().ToLower())}" (including the quotes) into your PowerShell session and execute it, then paste the resulting GUID string here'

# Author of this module
Author = 'Your name or your company name goes here'
